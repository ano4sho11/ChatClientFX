...
public class ClientUINodesManager extends StackPane {
    ...
    public ClientUINodesManager(Stage primarStage) {
    ...
    public boolean loadNode(String name, String layout) {
        try {
            ...
            ControlledNode controlledNode = (ControlledNode) fxmlLoader.getController();
    ...
    public boolean setNode(final String name, SlideAnimationDirection slideAnimationDirection) {
        if (mNodes.get(name) != null) {
            if (!getChildren().isEmpty()) {
                ...
                if (slideAnimationDirection == SlideAnimationDirection.GO_LEFT) {
